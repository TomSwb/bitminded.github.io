/**
 * Delete Account Translation System
 * Handles loading and updating translations for delete account component
 */
class DeleteAccountTranslations {
    constructor() {
    ...
    async loadTranslations() {
        try {
            const response = await fetch('/account/components/account-actions/delete-account/locales/delete-account-locales.json');
            if (!response.ok) {
    ...
    updateTranslations() {
        ...
        // Update all translatable content in delete account component
...
window.deleteAccountTranslations = new DeleteAccountTranslations();
