/**
 * 2FA Translation System
 * Handles loading and updating translations for 2FA component
 */
class TwoFactorAuthTranslations {
    constructor() {
    ...
    async loadTranslations() {
        try {
            const response = await fetch('/account/components/security-management/2fa/locales/2fa-locales.json');
            if (!response.ok) {
...
window.twoFactorAuthTranslations = new TwoFactorAuthTranslations();
