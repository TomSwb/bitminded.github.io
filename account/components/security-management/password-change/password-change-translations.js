/**
 * Password Change Translation System
 * Handles loading and updating translations for password change component
 */
class PasswordChangeTranslations {
    constructor() {
    ...
    async loadTranslations() {
        try {
            const response = await fetch('/account/components/security-management/password-change/locales/password-change-locales.json');
            if (!response.ok) {
    ...
    updateTranslations() {
        ...
        // Update all translatable content in password change component
...
window.passwordChangeTranslations = new PasswordChangeTranslations();
