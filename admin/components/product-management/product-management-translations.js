 ...
 * Handles translations for the product management component
 */

if (typeof window.productManagementTranslations === 'undefined') {
    window.productManagementTranslations = {
        translations: null,
        isInitialized: false,
        ...
        async init() {
            try {
                ...
                const response = await fetch('/admin/components/product-management/locales/product-management-locales.json');
