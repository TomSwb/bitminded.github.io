/**
 * Category Modal Translations
 * Handles translations for the category modal component
 */

if (typeof window.categoryModalTranslations === 'undefined') {
    window.categoryModalTranslations = {
        translations: null,
        isInitialized: false,
        ...
        async init() {
            try {
                ...
                window.logger?.error('❌ Category Modal Translations: Failed to initialize:', error);
                return false;
            }
        },
        ...
        updateTranslations() {
            if (!this.isInitialized) {
                window.logger?.warn('⚠️ Category Modal Translations: Not initialized, cannot update');
                return;
            }
