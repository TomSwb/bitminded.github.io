document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('/services/faq/lang-faq/locales-faq.json')
        .then(response => {
            if (!response.ok) {
        ...
        .catch(error => {
            window.logger?.error('Failed to load FAQ translations:', error);
            revealContent();
        });
    ...
    function applyTranslations() {
        ...
        revealContent();
        document.dispatchEvent(new CustomEvent('faqTranslationsApplied', {
            detail: {
