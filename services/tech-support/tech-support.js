/**
 * Tech Support Page Loader
 * Handles loading components and initializing the tech support page
 */
class TechSupportPageLoader {
    constructor() {
    ...
    initFAQAccordion() {
        const faqButtons = document.querySelectorAll('.tech-support-faq-item__button');
...
document.addEventListener('DOMContentLoaded', () => {
    window.techSupportPageLoader = new TechSupportPageLoader();
    window.techSupportPageLoader.init();
});
