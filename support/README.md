...
- **Operational Notes:**
  ...
  - Attachments (images, logs, PDFs) are captured via the form paste/upload dropzone, attached to the internal email, and metadata is saved alongside the ticket for admin visibility.
